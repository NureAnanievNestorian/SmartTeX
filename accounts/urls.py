...
urlpatterns = [
    ...
    path(".well-known/oauth-authorization-server/", oauth_authorization_server_metadata),
    path("authorize", oauth_authorize, name="authorize"),
    path("authorize/", oauth_authorize),
    path("register", oauth_register, name="oauth-register-root"),
    path("token", oauth_token, name="oauth-token-root"),
    path("token/", oauth_token),
    path("oauth/authorize/", oauth_authorize, name="oauth-authorize"),
    path("oauth/register/", oauth_register, name="oauth-register"),
    path("oauth/token/", oauth_token, name="oauth-token"),
    path("oauth/introspect/", oauth_introspect, name="oauth-introspect"),
]
