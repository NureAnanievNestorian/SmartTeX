...
from .views import (
    ...
    api_change_proposal_diff_annotation_detail,
    api_change_proposal_diff_annotations,
    api_change_proposal_discard,
    api_change_proposal_manual_edit,
...
urlpatterns = [
    ...
    path("projects/<int:project_id>/change-proposals/manual-edit/", api_change_proposal_manual_edit),
    path("projects/<int:project_id>/change-proposals/diff-annotations/", api_change_proposal_diff_annotations),
    path("projects/<int:project_id>/change-proposals/diff-annotations/<int:annotation_id>/", api_change_proposal_diff_annotation_detail),
