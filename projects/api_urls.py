...
from .views import (
    ...
    api_project_local_workspace,
    api_project_local_workspace_sync,
    api_project_pdf,
...
urlpatterns = [
    ...
    path("projects/<int:project_id>/local-workspace/", api_project_local_workspace),
    path("projects/<int:project_id>/local-workspace/sync/", api_project_local_workspace_sync),
